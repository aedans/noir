const starterDecks = {
  "Blue": ["Survey Tower","System of Tunnels","Workshop","Lesser Bank","Secret Passage","Assassination","Careful Detonation","Bank","Seek Truth","Seek Truth","Flare","Flare","Aspiring Lawman","Aspiring Lawman","Bring to Justice","Confiscate Plans","Civic Servant","Bodyguard","Bodyguard","Ruthless Investigator","Ruthless Investigator","Impound Office","Mass Detain","Tax Collector","Executioner","Captain Belmont","Lawman Academy","Prison","Exhaustive Search","Grand Confiscator"],

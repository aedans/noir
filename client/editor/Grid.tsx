...
export type GridProps = {
  ...
  children: (t: CardState, ref: Ref<Container>, x: number, y: number, i: number) => ReactElement;
};
...
export default React.memo(
  ...
  (a, b) => deepEqual(a.elements.map(x => x.name), b.elements.map(x => x.name)) && deepEqual(a.margin, b.margin) && deepEqual(a.maxWidth, b.maxWidth)
);
